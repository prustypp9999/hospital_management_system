...
<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><i
			class="fa-solid fa-truck-medical"></i>CureWell</a>
			...
			<form class="d-flex" >
				...
				<div class="dropdown">
					<button class="btn btn-light dropdown-toggle" type="button"
						...
						aria-expanded="false">
						<i class="fas fa-user-circle"></i>Dr. ${doctObj.fullName }
					</button>
					<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
						<li><a class="dropdown-item" href="edit_profile.jsp">Edit
								Profile</a></li>
					   <li><a class="dropdown-item" href="d_change_password.jsp">Change Password</a></li>
